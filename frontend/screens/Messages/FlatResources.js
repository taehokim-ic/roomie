...
const FlatResources = ({ navigation }) => {
  const sections = [
    {
      id: 1,
    ...
    {
      id: 3,
      image: require('../../assets/resources/walletx.jpg'),
    ...
    {
      id: 5,
      image: require('../../assets/flatfinding/leave.jpg'),
      title: 'Match not working out?',
      description: 'Maybe it\'s time to look for another flatmate',
      route: 'Channel',
    },
  ];
